...
// UploadedFile is the structure used to store information about the uploaded file.
...
// CreateDirIfNotExist creates a directory if it does not exist and all parent directories.
